...
tangent_F_real=8;
tangent_ratio_real=1/2;
A_force_ratio=[tangent_F_real,tangent_ratio_real];
...
f=@(tangent_var) myfunc(tangent_var,Delta1_noised,Delta2_noised,tangent_ratio_real);
...
%%
function r=myfunc(tangent_var,Delta1,Delta2,tangent_ratio)
