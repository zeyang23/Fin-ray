...
% 失败的参数 关闭options中提供的梯度，用fsolve能算出来一个奇怪的形状
% 第1根刚性约束
ka1=fix(1/5*nA);
kb1=fix(1/5*nB);
...
f=@(x) myfun(x,xA,xB,yA,yB,beta,beta_degree,alpha,alpha_degree,A,B,b,nA,nB,RA,RB,Lcon1,Lcon2,Lcon3,Lcon4,ka1,ka2,ka3,ka4,kb1,kb2,kb3,kb4,lambdaA1,lambdaA2,lambdaA3,lambdaA4,lambdaB1,lambdaB2,lambdaB3,lambdaB4);
...
%%
function [r,J]=myfun(x,xA,xB,yA,yB,beta,beta_degree,alpha,alpha_degree,A,B,b,nA,nB,RA,RB,Lcon1,Lcon2,Lcon3,Lcon4,ka1,ka2,ka3,ka4,kb1,kb2,kb3,kb4,lambdaA1,lambdaA2,lambdaA3,lambdaA4,lambdaB1,lambdaB2,lambdaB3,lambdaB4)
