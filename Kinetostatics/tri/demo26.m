...
% 21-04-17
% 多点接触的测试效果还不错
% 半径小的话，finray抓物体更像单点接触，即使我设置为5点接触，这5个点算出来也是重合的
% 重合的时候，把这5个力加起来，算出来的和当作单点接触的力是一样的

% 半径大的时候，finray抓物体确实更像线接触，设置为5点接触的话，解出来的5个点分的比较开

% matlab的内置算法真的棒，在没有梯度的情况下，多点的方程也能算出来像样的结果，成功拯救了lzy的毕设
% 有机会一定要学一学这个神奇的trust region算法
