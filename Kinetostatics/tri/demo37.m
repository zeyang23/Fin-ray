...
vid = VideoWriter('finray_static_friction_2');
...
function res=solve_up(theta_up,DELTA,Xc,Yc,radius,Theta_0,L0_up,problem_info_init,plot_flag)
    ...
    E=problem_info_init.E;
    LA=L0_up-radius*(theta_up-Theta_0);
    
    wid=problem_info_init.wid;
    thi=problem_info_init.thi;
    

    
    RA=planar_nR(E,LA,wid,thi,nA,[0;0;0]);
    ...
    M=transpose(pe_A(1:2))*[0 1;-1 0]*FA(1:2)+FA(3);
    
    res=-M-RA.E*RA.Iz/radius;
