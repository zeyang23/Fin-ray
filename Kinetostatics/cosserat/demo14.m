...
M1=interp1(sB_total,YB_total(:,6),lambda_K1);
K1_true=M1/EB/IB;

M2=interp1(sB_total,YB_total(:,6),lambda_K2);
K2_true=M2/EB/IB;

M3=interp1(sB_total,YB_total(:,6),lambda_K3);
K3_true=M3/EB/IB;
...
problem_info_shape.lambda_K1=lambda_K1;
problem_info_shape.K1=K1;

problem_info_shape.lambda_K2=lambda_K2;
problem_info_shape.K2=K2;

problem_info_shape.lambda_K3=lambda_K3;
problem_info_shape.K3=K3;
...
problem_info.lambda1=lambda1;
problem_info.lambda2=lambda2;
problem_info.press=transpose(x_shape(16:18));
...
function res=check_shape(x,problem_info,psi,pA,pB,LA,LB,EA,EB,IA,IB)
    ...
    lambda_K1=problem_info.lambda_K1;
    K1=problem_info.K1;
    
    lambda_K2=problem_info.lambda_K2;
    K2=problem_info.K2;
    
    lambda_K3=problem_info.lambda_K3;
    K3=problem_info.K3;
    
    
    press=transpose(x(16:18));
    ...
    M1_now=interp1(sB_total,YB_total(:,6),lambda_K1);
    K1_now=M1_now/EB/IB;
    
    M2_now=interp1(sB_total,YB_total(:,6),lambda_K2);
    K2_now=M2_now/EB/IB;
    
    M3_now=interp1(sB_total,YB_total(:,6),lambda_K3);
    K3_now=M3_now/EB/IB;
