...
f=@(tangent_var) myfunc_1(tangent_var,DeltaA,DeltaB,lambda1,lambda2);
...
A_force_ratio=[];
A_force_ratio=[tangent_F1,lambda1;
               tangent_F2,lambda2];
...
function r=myfunc_1(tangent_var,Delta1,Delta2,lambda1,lambda2)


    tangent_F1=tangent_var(1);
    tangent_F2=tangent_var(2);
